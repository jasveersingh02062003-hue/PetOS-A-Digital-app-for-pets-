...
INSERT INTO public.posts (id, author_id, pet_id, caption, image_url, created_at) VALUES
  ...
  ('22222222-0000-0000-0000-000000000005', v_owner2, v_pet6, 'Coco got a new haircut âœ¨ #pomeranian #grooming', 'https://images.unsplash.com/photo-1583511655826-05700d52f4d9?w=800', now() - interval '2 days'),
  ('22222222-0000-0000-0000-000000000006', v_owner1, v_pet7, 'Simba on patrol ðŸ… #bengalcat', 'https://images.unsplash.com/photo-1561948955-570b270e7c36?w=800', now() - interval '3 days'),
  ...
  ('22222222-0000-0000-0000-000000000008', v_owner1, v_pet1, 'Park run completed ðŸƒ 5km with Pablo. #dogwalk', 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=800', now() - interval '6 days')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.meetups (id, host_id, title, description, city, venue, lat, lng, starts_at, capacity, cover_url) VALUES
  ...
  ('33333333-0000-0000-0000-000000000003', v_owner1, 'Cat Cafe Mixer',          'For cat parents only â€” meet over chai and kitty pics.', 'Delhi', 'Cat Cafe, Hauz Khas', 28.5494, 77.2001, now() + interval '8 days',  15, 'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=800'),
...
DECLARE
  ...
  captions text[] := ARRAY[
    'Sunday morning walks ðŸ¾','Best buddy in the world â¤ï¸','Beach day vibes','Sleepy puppy face',
    'Treat time! ðŸ¦´','New trick learned today','Park adventures','Just look at this face',
    'Birthday today ðŸŽ‰','Vet checkup â€” all healthy!','Bath day struggles ðŸ›','Found a new toy',
    'Lazy afternoons','Adoption journey day 1','Snuggles âœ¨','Training pays off!','Morning zoomies',
    'Pet parent life','Forever home found','Garden patrol','Met a new friend at the park',
    'Indie pride ðŸ‡®ðŸ‡³','Adopt don''t shop','Sunset walk','Cat tax ðŸ“¸','Yoga buddy','Office mascot',
    'Hiking with the gang','Festival ready','Diwali safe pet tips','Vaccination done âœ…'
  ];
  i int; j int;
...
BEGIN
  ...
  FOR i IN 1..1000 LOOP
    ...
    VALUES (
      ...
      user_ids[1 + (random() * (array_length(user_ids,1)-1))::int],
      CASE (i % 12)
        WHEN 0 THEN 'So cute! ðŸ˜' WHEN 1 THEN 'Awwww â¤ï¸'
        ...
        WHEN 6 THEN 'Goodest boy ðŸ¥º' WHEN 7 THEN 'Sending treats from afar ðŸ¦´'
        WHEN 8 THEN 'Such a smart pet' WHEN 9 THEN 'How old?'
        WHEN 10 THEN 'Best post today' ELSE 'I needed this on my timeline ðŸ¾'
      END,
